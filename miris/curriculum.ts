  ...
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        body:
          "Open app/layout.tsx and comment out the MirisGuide line. That is the only place this guide touches your app. Everything else it did lives in your own files now.",
        code: "{/* <MirisGuide /> */}",
      },
      {
        num: "5.3",
